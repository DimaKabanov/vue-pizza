        ...
        <div class="content__dough">
          <div class="sheet">
            ...
            <div class="sheet__content dough">
              <label
                v-for="doughItem in normalizedDough"
                :key="doughItem.id"
                :class="`dough__input dough__input--${doughItem.size}`"
              >
                <input
                  :value="doughItem.size"
                  type="radio"
                  name="dought"
                  class="visually-hidden"
                />
                <img
                  :src="getImage(doughItem.image)"
                  width="36"
                  height="36"
                  alt=""
                  role="presentation"
...
const normalizedSauces = sauces.map(normalizeSauce);
